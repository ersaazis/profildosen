...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-xs-center">
                    <h3 class="mbr-section-title display-2">{{$ps->nama}}</h3>
                    <div class="lead"><a href="{{$ps->url}}" target="_blank">Sumber</a></div>
                </div>
            </div>
        </div>
    </section>
    <section class="mbr-section">
        <div class="container">
            <div class="row">
		    	{!! str_replace('table1','table table-striped',$ps->profil) !!}
            </div>
        </div>
    </section>
